    ...
    const sources: ContextSources = {
      personality: {
        profile: {
          ...
          dimensions: {
            warmth: 8, energy: 7, openness: 9, emotional_depth: 8,
            playfulness: 6, supportiveness: 9, curiosity: 10, wisdom: 7,
          },
          preferences: { pace: "moderate", formality: "casual", humor_style: "warm", emotional_expression: "expressive" },
          behaviors: { proactivity: "high", reliability: "high", humor: "warm" },
          emotional_tendencies: {},
        },
        evolution: [],
      },
